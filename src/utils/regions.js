...
const regionData = [
  ...
  },
  {
    ...
    cities: [
      ...
      { value: '博尔塔拉蒙古自治州', label: '博州' },
      { value: '巴音郭楞蒙古自治州', label: '巴州' },
      { value: '阿克苏地区', label: '阿克苏' },
      { value: '克孜勒苏柯尔克孜自治州', label: '克州' },
      { value: '喀什地区', label: '喀什' },
      { value: '和田地区', label: '和田' },
      { value: '伊犁哈萨克自治州', label: '伊犁州' },
      { value: '塔城地区', label: '塔城' },
      { value: '阿勒泰地区', label: '阿勒泰' }
    ]
  },
  {
    value: '香港特别行政区',
...
export function getCitiesByProvince(provinceName) {
  const province = regionData.find(item => item.value === provinceName)
